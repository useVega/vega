...
The system is organized into 9 core modules:
...
### 3. **Frontend Abstraction** (`src/frontend/`) ✨ NEW
- **Unified Client Interface**: Single entry point for all operations
- **WorkflowClient**: Parse, execute, and monitor workflows
- **AgentClient**: Search, create, and manage agents
- **PaymentClient**: Budget management and payments
- **Type-Safe API**: Full TypeScript support with 15+ types
- **Framework Agnostic**: Works with React, Vue, Angular, etc.

### 4. **Payment Layer** (`src/payment/`)
...
### 6. **Trust & Reputation** (`src/trust/`) [Coming Soon]
- Agent identity (ERC-8004 AgentID)
- Reputation scoring
- Feedback collection
- Validation records

### 7. **Identity & Wallet** (`src/identity/`) [Coming Soon]
- User profile management
- Wallet mapping
- Developer payout configuration

### 8. **Monitoring & Logging** (`src/monitoring/`) [Coming Soon]
- Audit logs
- System metrics
- Performance tracking

### 9. **Multi-Chain Abstraction** (`src/multichain/`) [Coming Soon]
...
│   │   └── errors.types.ts
│   │
│   ├── frontend/           # Frontend Abstraction ✨ NEW
│   │   ├── agentic-client.ts
│   │   ├── workflow-client.ts
│   │   ├── agent-client.ts
│   │   ├── payment-client.ts
...
### Quick Start with Frontend Abstraction
...
- **Quick Reference**: [FRONTEND_QUICK_REF.md](./FRONTEND_QUICK_REF.md)
- **Complete Guide**: [FRONTEND_ABSTRACTION.md](./FRONTEND_ABSTRACTION.md)
- **React Examples**: [examples/react-components.tsx](./examples/react-components.tsx)
- **Overview**: [FRONTEND_OVERVIEW.md](./FRONTEND_OVERVIEW.md)
